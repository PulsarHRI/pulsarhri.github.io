...
- **Connection**: The actuator must be **powered on** and connected **directly via USB**.
- **Compatibility**: Tested on **Windows**.  
  > _Linux and macOS support is experimental and is currently under review_

At this stage, the app supports controlling **one actuator at a time**.

### 📦 How to Get the App

The app can be downloaded [here](../../download/download_app.md).
